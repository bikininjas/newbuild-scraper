...
def detect_anti_bot_protection(content):
    ...
    anti_bot_indicators = [
        'cloudflare', 'checking your browser', 'please wait', 'verification',
        'captcha', 'robot', 'bot detection', 'security check', 'ddos protection',
        'javascript required', 'enable javascript', 'turnstile'
    ]
    
    content_lower = content.lower()
    detected_systems = [indicator for indicator in anti_bot_indicators if indicator in content_lower]
